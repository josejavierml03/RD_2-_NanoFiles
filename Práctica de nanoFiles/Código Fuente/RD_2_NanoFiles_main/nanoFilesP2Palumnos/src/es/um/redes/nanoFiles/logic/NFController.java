	...
	public boolean canProcessCommandInCurrentState() {
		...
		case NFCommands.COM_LOGOUT:
			if (currentState == LOGGED_IN || currentState == BGSERVE) {
				...
				System.err.println("* You cannot logout because you are not logged in from the directory");
				commandAllowed = false;
			}
			break;
		...
		case NFCommands.COM_USERLIST:
			if (currentState != LOGGED_IN) {
				commandAllowed = false;
				System.err.println("* You cannot ask for the userlist if you are not logged in from the directory");
			}
			break;
		...
		case NFCommands.COM_FGSERVE:
			if (currentState != LOGGED_IN) {
				commandAllowed = false;
				System.err.println("* You cannot launch a forground server if you are not logged in from the directory");
			}
			break;
		...
		case NFCommands.COM_BGSERVE:
			if(currentState == BGSERVE) {
				commandAllowed = false;
				System.err.println("* You cannot launch a background server if you already started one");
			}else if(currentState != LOGGED_IN) {
				commandAllowed = false;
				System.err.println("* You cannot launch a background server if you are not logged in from the directory");
			}
			break;	
		...
		case NFCommands.COM_STOP_SERVER:
			if (currentState != BGSERVE) {
				commandAllowed = false;
				System.err.println("* You cannot stop a background server if you didn't launch a background server");
			}
			break;	
		...
		case NFCommands.COM_QUIT:
			if (currentState == BGSERVE) {
				commandAllowed = false;
				System.err.println("* Close the background server before quitting");
			}else if(currentState == LOGGED_IN) {
				commandAllowed = false;
				System.err.println("* Logout before quitting");
			}
			break;	
